    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-background)] text-[var(--color-foreground)] font-inter">
      ...
      <header className="flex items-center justify-between px-6 py-4">
        <div className="flex flex-col gap-2">
          <button
            onClick={() => router.back()}
            className="bg-[var(--azul-segundario)] text-white font-inter flex items-center gap-2 px-4 py-2 rounded hover:opacity-90"
          >
          ...
          <button
            onClick={() => router.push("/")}
            className="bg-[var(--azul-segundario)] text-white font-inter px-4 py-2 rounded hover:opacity-90"
          >
            Página inicial
          </button>
        </div>
      ...
      {/* Main */}
      <main className="flex flex-col items-center px-6 py-8 bg-[var(--color-background)]">
        <div className="w-full max-w-sm flex flex-col">
          <h2 className="text-2xl text-[var(--destaque)] font-bold font-inter mb-8">
            Cadastro
          </h2>

          <div className="flex flex-col gap-6 w-full">
            <button className="bg-[var(--destaque)] text-white font-inter py-4 rounded-md text-lg font-semibold hover:opacity-90">
              Aluno
            </button>

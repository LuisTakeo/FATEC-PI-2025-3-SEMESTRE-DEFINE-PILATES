  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-inter">
      ...
      <main className="flex flex-col items-center justify-center flex-1 px-6 py-6">
        <h2 className="text-2xl font-bold text-[#832965] mb-2">Digite o código</h2>
        ...
        <p className="text-sm text-black mt-6 text-center">
          Não recebeu seu código? <br />
          Retorne à tela anterior e reescreva seu e-mail e clique em solicitar código novamente em{" "}

...
function PaginaInicio(){
    ...
    <main className={`${Estilizacoes.container_main} w-full`}>
        ...
        <section className="flex justify-center items-center py-[5%] w-full h-[800px]">
            <div className="flex items-start justify-end flex-col w-full h-full bg-[url('/womanbackgrounf.png')] bg-right bg-no-repeat bg-cover px-[8%] py-[8%]">
                <div className="w-[80%] bg-[var(--background)] rounded-[10px]">
                    <h1 className="text-[2.5rem] font-semibold text-[var(--destaque)] bg-[var(--background)] 
                    w-auto py-3 px-5 text-start rounded-[10px]">
                        Agende sua aula experimental totalmente gratuita conosco!

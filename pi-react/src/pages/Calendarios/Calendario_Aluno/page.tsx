...
export default function Calendario_Aluno() {
  ...
  return (
    <main className="w-full h-full flex flex-col gap-6">
      ...
      <BlocoCalendario aulas={aulas} cargo={"aluno"}/>
